...
func (in *CloudConfigEnvList) DeepCopyInto(out *CloudConfigEnvList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]CloudConfigEnv, len(*in))
		for i := range *in {
...
func (in *CloudConfigSpec) DeepCopyInto(out *CloudConfigSpec) {
	*out = *in
	in.CloudConfigEnvSpec.DeepCopyInto(&out.CloudConfigEnvSpec)
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make(map[string]CloudConfigEnvSpec, len(*in))
